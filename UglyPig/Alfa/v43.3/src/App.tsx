...
function IntroCorral({ x, y }: { x: number; y: number }) {
  return (
    ...
    >
      ...
      >
        <IntroFenceRun width={126} left={8} top={172} rotate={0} />
        <IntroFenceRun width={126} left={206} top={172} rotate={0} />
        <IntroFenceRun width={162} left={-18} top={96} rotate={-71} opacity={0.96} />
        <IntroFenceRun width={162} left={196} top={96} rotate={71} opacity={0.96} />
        <IntroFenceRun width={112} left={14} top={52} rotate={-28} opacity={0.92} />
        <IntroFenceRun width={112} left={214} top={52} rotate={28} opacity={0.92} />
      </div>
    </div>
  );
}
