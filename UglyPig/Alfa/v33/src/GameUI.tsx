  ...
  if (isGameOver) {
    return (
      <div className="absolute inset-0 bg-black/55 flex flex-col items-center justify-center z-40 px-4">
        ...
        <div className="relative w-[82%] max-w-[320px] rounded-[28px] p-[6px] shadow-2xl bg-[linear-gradient(to_bottom,#A6CE12_0%,#88A808_45%,#789808_70%,#588008_100%)]">
          ...
          <PersonalRecordsPanel records={personalRecords} newRecords={newPersonalRecords} />
  ...
  return (
    <div className="absolute inset-0 bg-black/55 flex flex-col items-center justify-center z-40 px-4">
      <div className="relative w-[90%] max-w-[352px] rounded-[28px] p-[6px] shadow-2xl bg-[linear-gradient(to_bottom,#A6CE12_0%,#88A808_45%,#789808_70%,#588008_100%)]">
        ...
        <PersonalRecordsPanel records={personalRecords} newRecords={{ daily: false, weekly: false, monthly: false }} compact />
