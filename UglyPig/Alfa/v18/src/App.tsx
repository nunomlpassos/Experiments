...
export default function App() {
  ...
  useEffect(() => {
    const t = setTimeout(() => setShowBrandSplash(false), 2000);
  ...
  const toggleDirection = useCallback(() => {
    const state = gameStateRef.current;
    if (showBrandSplash || !hasStarted || isPaused || countdown !== null || isLandscape || showExitConfirm) return;
  ...
  return (
    <div className="w-screen h-screen bg-sky-300 overflow-hidden">
      ...
      >
        {showBrandSplash && (
          <div className="absolute inset-0 z-[90] bg-white flex items-center justify-center">
