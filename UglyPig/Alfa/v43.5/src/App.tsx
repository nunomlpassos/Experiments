  ...
  return (
    <div
      ...
      style={{
        ...
        height: "38px",
        borderRadius: "12px",
        background: "linear-gradient(90deg, #9b5a0c 0%, #d08a22 48%, #8e4f08 100%)",
        border: "1px solid #764205",
        boxShadow: "inset -2px 0 0 rgba(255,255,255,0.24), inset 2px 0 0 rgba(0,0,0,0.16)",
      }}
    >
      <div
        className="absolute"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IntroCornerPost left={15} top={16} />
        <IntroCornerPost left={299} top={16} />
        <IntroCornerPost left={15} top={181} />
        <IntroCornerPost left={299} top={181} />
      </div>
    </div>
  );
}
