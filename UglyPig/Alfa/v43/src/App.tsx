...
const RUN_INTRO_CORRAL_WIDTH = 240;
const RUN_INTRO_CORRAL_HEIGHT = 150;
...
function IntroCorral({ x, y }: { x: number; y: number }) {
  return (
    ...
    >
      <div className="absolute left-1/2 top-0 h-[96px] w-[126px] -translate-x-1/2">
        <div
          className="absolute left-0 top-[28px] h-[68px] w-full rounded-t-[10px] border-[3px] border-[#78380d]"
          style={{
            background: "linear-gradient(90deg,#9d3f19 0%,#cf5a24 52%,#8e3515 100%)",
            boxShadow: "inset 0 8px 0 rgba(255,255,255,.14), inset 0 -8px 0 rgba(70,22,8,.2)",
          }}
        />
        <div
          className="absolute left-[-8px] top-[3px] h-[43px] w-[142px]"
          style={{
            clipPath: "polygon(50% 0%, 100% 100%, 0% 100%)",
            background: "linear-gradient(90deg,#6c2e10 0%,#8d3b15 50%,#552108 100%)",
            border: "3px solid #4b1c07",
          }}
        />
        <div className="absolute bottom-0 left-1/2 h-[50px] w-[46px] -translate-x-1/2 rounded-t-[8px] border-[3px] border-[#4a230c] bg-[#2b1609]" />
      </div>

      <div className="absolute bottom-[8px] left-0 h-[72px] w-full">
        {[0, 1, 2, 3, 4, 5, 6, 7, 8].map((idx) => (
          <div
            key={idx}
            className="absolute bottom-0 w-[18px] rounded-t-[9px] border border-[#774407]"
            style={{
              left: `${idx * 27}px`,
              height: `${idx % 2 === 0 ? 68 : 60}px`,
              background: "linear-gradient(90deg,#a86312 0%,#d18a25 52%,#8f5109 100%)",
              clipPath: "polygon(50% 0%, 100% 16%, 100% 100%, 0% 100%, 0% 16%)",
              boxShadow: "inset -2px 0 0 rgba(0,0,0,.15), inset 2px 0 0 rgba(255,255,255,.22)",
            }}
          />
        ))}
        <div className="absolute left-[-8px] right-[-8px] top-[24px] h-[11px] rounded-full border border-[#774407] bg-[#b66d16]" />
        <div className="absolute left-[-8px] right-[-8px] top-[45px] h-[11px] rounded-full border border-[#774407] bg-[#a86111]" />
      </div>
    </div>
  );
}
