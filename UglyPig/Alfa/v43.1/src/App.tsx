...
import introCorralImage from "./assets/intro-corral.webp";
...
const RUN_INTRO_CORRAL_WIDTH = 270;
const RUN_INTRO_CORRAL_HEIGHT = 205;
...
function IntroCorral({ x, y }: { x: number; y: number }) {
  return (
    ...
    >
      <img src={introCorralImage} alt="" className="h-full w-full object-contain select-none" draggable={false} />
    </div>
  );
}
