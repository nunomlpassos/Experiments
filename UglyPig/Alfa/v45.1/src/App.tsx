    ...
    <div className="w-screen h-screen bg-sky-300 overflow-hidden">
      ...
      >
        ...
        {!hasStarted && (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-end justify-center pb-20">
              <button
                type="button"
                className="pressable-button rounded-2xl bg-transparent p-0 border-0 shadow-none"
                onClick={(e) => {
                  e.stopPropagation();
                  beginRunIntro();
                }}
        ...
        {!renderState.isGameOver && countdown === null && !runIntro.active && !isPaused && !showExitConfirm && hasStarted && !isLandscape && (
          <button
            type="button"
            className="pressable-button absolute top-2 right-2 z-30 w-14 h-14 appearance-none bg-transparent border-0 p-0 m-0 shadow-none outline-none"
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="pressable-button h-[62px] rounded-2xl bg-transparent p-0 border-0 shadow-none"
                  onPointerDown={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                  }}
